  ...
  return (
    <div className="flex flex-col item-center justify-center bg-white">
      ...
      <div className="mt-16 flex flex-col justify-center items-center">
        <h2 className="text-2xl text-black font-semibold">Create an Event</h2>
      </div>
      ...
      <div className="flex flex-col justify-center items-center mt-6">
        <form className="flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
          ...
          <Label labelText="Upload Event Photo" customClass="text-md" />
          ...
          <Button
            buttonType="submit"
            customClass="flex justify-center item-center !bg-primary w-100 font-semibold text-sm !py-0"
            disabled={isLoading}
          >
            <div className="flex items-center justify-center relative min-w-48 min-h-12">
              {isLoading ? <Loader mode="container" /> : "Create Event"}
            </div>
          </Button>
        </form>
      </div>
